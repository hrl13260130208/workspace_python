...
def put_url_0(url):
    ...
    for i in range(601):
        ...
        for div_tag in soup.find_all("div", class_="List2"):
            for a_tag in div_tag.find_all("a"):
                urls.append("http://www.hngp.gov.cn"+a_tag["href"])
...
if __name__ == '__main__':
    ...
    url = " "
    file_path = "C:/file/ResultFile/hngp_spider_result.txt"

    names=Name_Manager("hngp",2)
    thread=[]
