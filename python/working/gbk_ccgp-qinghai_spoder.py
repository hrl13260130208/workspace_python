...
def put_url_0(url):
    urls=[]
    for num in range(1112):
        urls.append("http://www.ccgp-qinghai.gov.cn/jilin/zbxxController.form?declarationType=&type=1&pageNo="+str(num))
    return urls
...
if __name__ == '__main__':
    ...
    url = " "
    file_path = "C:/file/ResultFile/ccgp-qinghai_spider_result.txt"

    names=Name_Manager("ccgp-qinghai",3)
    thread=[]
